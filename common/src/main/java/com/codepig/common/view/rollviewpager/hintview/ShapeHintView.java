package com.codepig.common.view.rollviewpager.hintview;
...
import com.codepig.common.view.rollviewpager.HintView;
import com.codepig.common.view.rollviewpager.Util;
	...
	public void initView(int length, int gravity) {
        ...
        for (int i = 0; i < length; i++) {  
        	...
        	LayoutParams dotlp = new LayoutParams(
        			...
        			LayoutParams.WRAP_CONTENT);
        	dotlp.setMargins(Util.dip2px(getContext(),3), 0, Util.dip2px(getContext(),3), 0);
