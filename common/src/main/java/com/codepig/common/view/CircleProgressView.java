...
public class CircleProgressView extends View {
    ...
    private int mProgressColor = getResources().getColor(R.color.press_green);//进度条颜色
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mProgressWidth = typedArray.getDimension(R.styleable.CircleProgressView_progress_width, dp2px(context, 2));
        ...
        mBgPaint.setColor(getResources().getColor(R.color.trans_white3));
