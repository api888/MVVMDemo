 ...
 *
 * <p>Here is a simple demo of using a FragmentTabHost in an Activity:
 *
 * {@sample development/samples/Support4Demos/src/com/codepig/android/supportv4/app/FragmentTabs.java
 *      complete}
 *
...
public class MyFragmentTabHost extends TabHost
    ...
    public void addTab(TabSpec tabSpec, Class<?> clss, Bundle args) {
        ...
        if (mAttached) {
            ...
            // btn_receipt_sure this tab's fragment is inactive if it exists.  This shouldn't
            // normally happen.
...
//                ft.commit();
    ...
    protected void onAttachedToWindow() {
        ...
        // Go through all tabs and make btn_receipt_sure their fragments match
        // the correct state.
        ...
        // We are now ready to go.  Make btn_receipt_sure we are switched to the
        // correct tab.
        mAttached = true;
