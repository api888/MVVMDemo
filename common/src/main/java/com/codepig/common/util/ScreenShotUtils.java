...
public class ScreenShotUtils {
     ...
     * @return Bitmap
     */
    public static Bitmap getViewBitmap(View v,int _height) {
        if (null == v) {
            return null;
        }
        v.setDrawingCacheEnabled(true);
        ...
        Bitmap bitmap = Bitmap.createBitmap(v.getDrawingCache(), 0, 0, v.getMeasuredWidth(), _height);
        v.setDrawingCacheEnabled(false);
        v.destroyDrawingCache();
        return bitmap;
    }
