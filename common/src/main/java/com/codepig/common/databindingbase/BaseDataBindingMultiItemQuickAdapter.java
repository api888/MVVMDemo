...
import com.codepig.common.entity.MultiItemEntity;

import java.util.List;

public abstract class BaseDataBindingMultiItemQuickAdapter<T extends MultiItemEntity> extends BaseDataBindingAdapter<T, ViewDataBinding> {

    public BaseDataBindingMultiItemQuickAdapter(int layoutResId, @Nullable List data) {
        super(layoutResId, data);
    }

    public BaseDataBindingMultiItemQuickAdapter(@Nullable List data) {
        super(data);
    }
    ...
    @Override
    protected BaseBindingViewHolder onCreateDefViewHolder(ViewGroup parent, int viewType) {
