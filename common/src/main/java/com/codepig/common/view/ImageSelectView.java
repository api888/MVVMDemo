...
import com.codepig.common.bean.UploadImage;
...
import com.codepig.common.databinding.AlertDialogSelectImageBinding;
...
import com.codepig.common.util.CommonUtils;
import com.codepig.common.util.DensityUtil;
import com.codepig.common.util.FileUtil;
import com.codepig.common.util.ImageUtil;
...
//        }
    ...
    public static void showAddImageDialog(final Activity activity, final int count, final String filePath) {
        ...
        binding.tvAddImagePhone.setOnClickListener(new OnClickListener() {
            @Override
        ...
        binding.tvAddImageGalley.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (dialog.isShowing()) {
                    dialog.dismiss();
